...
<div class="wrapper">
	<nav id="sidebar" class="sidebar js-sidebar">
		<div class="sidebar-content js-simplebar">
			<a class="sidebar-brand" href="<?= $baseUrl; ?>customer">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-item <?= page("orders", $page); ?>">
					<a class="sidebar-link" href="<?= $baseUrl; ?>customer/orders">
				...
				<li class="sidebar-item <?= page("orderHistory", $page); ?>">
					<a class="sidebar-link" href="<?= $baseUrl; ?>customer/order-history">
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<div class="navbar-collapse collapse">
				<ul class="navbar-nav navbar-align">
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
							...
							<div class="list-group">
								...
								if (mysqli_num_rows($result) > 0) {
									...
									echo "<div class='list-group-item'>";
										echo "<span class='text-center p-3'>No notifications yet..</span>";
									echo "</div>";
							...
							<div class="dropdown-menu-footer">
								<a href="<?= $baseUrl ?>customer/notifications" class="text-muted">Show all notifications</a>
							</div>
						</div>
					</li>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
							...
							<div class="list-group">
								...
								$sql = "SELECT a.* FROM messages a INNER JOIN (SELECT id, user_role, message, created_at, MAX(id) AS maxid FROM messages GROUP BY sellers_id) as b ON a.id = b.maxid ORDER BY a.id DESC";
								$result = mysqli_query($conn, $sql);
								...
								if (mysqli_num_rows($result) > 0) {
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										while ($row2 = mysqli_fetch_assoc($result2)) {
											...
											echo "<a href='" . $baseUrl . "customer/chat?id=" . $usersId . "' class='list-group-item'>";
												echo "<div class='row g-0 align-items-center'>";
													echo "<div class='col-2'>";
									...
									echo "<div class='list-group-item text-center p-3'>";
										echo "<span class=''>No messages yet..</span>";
									echo "</div>";
					...
					<li class="nav-item dropdown">
						<a class="nav-icon dropdown-toggle" href="<?= $baseUrl; ?>customer/cart">
							<div class="position-relative">
								...
								$sql = "SELECT COUNT(id) as count FROM carts WHERE customers_id = $usersId AND status = 1 ORDER BY id DESC";
								$result = mysqli_query($conn, $sql);
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-end">
							<a class="dropdown-item" href="<?= $baseUrl; ?>customer/profile"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
