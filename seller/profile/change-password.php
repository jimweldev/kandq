		...
		echo "<div class='row'>";
			echo "<div class='col-lg-4'>";
				echo "<div class='list-group'>";
					echo "<a href='" . $baseUrl . "seller/profile' class='list-group-item list-group-item-action'>
					Update Profile
					</a>";
					echo "<a href='" . $baseUrl . "seller/profile/complete-address' class='list-group-item list-group-item-action'>Complete Address</a>";
					echo "<a href='" . $baseUrl . "seller/profile/change-password' class='list-group-item list-group-item-action active'>Change Password</a>";
				echo "</div>";
			echo "</div>";
			...
			echo "<div class='col-lg-8'>";
				...
				echo "<form action='" . $baseUrl . "assets/includes/seller/profile.inc.php' method='POST' enctype='multipart/form-data'>";
					...
					echo "<div class='mb-3'>";
						...
						echo "<input class='form-control form-control-lg' type='password' placeholder='Confrim new password' name='confirmPassword' required>";
					echo "</div>";
