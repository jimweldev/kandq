...
$sql = "SELECT * FROM users WHERE id = $customersId";
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	echo "<div class='card'>";
		...
		echo "<form class='card-footer input-group mb-3' action='" . $baseUrl . "assets/includes/seller/chat.inc.php' method='POST'>";
