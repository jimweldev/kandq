...
$sql = "SELECT orders.id as orders_id, products.id as products_id, products.name as name, orders.delivery_date as delivery_date, orders.price as price, orders.quantity as quantity, orders.shipping_fee as shipping_fee, orders.total_price as total_price, orders.customers_id as customers_id, orders.sellers_id as sellers_id
FROM orders
LEFT JOIN products
					...
					echo "<div class='col-lg-5'>";
						...
						echo "<table class='table table-bordered w-100 mb-3'>";
							...
							echo "<tr>";
								...
								if (isset($row["delivery_date"]) < date('m/d/Y', time())) {
