...
<form class="input-group mb-4" action="<?= $baseUrl ?>assets/includes/customer/search.inc.php" method="POST">
	...
	<button class="input-group-text btn-success" type="submit" name="searchOrderHistory"><i class="align-middle" data-feather="search"></i></button>
</form>
			...
			echo "<div class='card-body'>";
				echo "<div class='row'>";
					echo "<div class='col-lg-8'>";
						...
						// echo "<img class='rounded w-100' src='../assets/img/photos/unsplash-1.jpg'>";
					echo "</div>";
