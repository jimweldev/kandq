			...
			echo "<div class='row'>";
				echo "<div class='col-lg-4'>";
					echo "<div class='list-group'>";
						echo "<a href='" . $baseUrl . "customer/profile' class='list-group-item list-group-item-action active'>
						Update Profile
						</a>";
						...
						echo "<div class='mb-3'>";
							...
							echo "<div class='row g-3'>";
								echo "<div class='col-lg-6'>";
									echo "<input class='form-control form-control-lg' type='text' placeholder='First name' name='firstname' value='" . $row["firstname"] . "' required>";
								echo "</div>";
								echo "<div class='col-lg-6'>";
									echo "<input class='form-control form-control-lg' type='text' placeholder='Last name' name='lastname' value='" . $row["lastname"] . "' required>";
								echo "</div>";
							echo "</div>";
						echo "</div>";
