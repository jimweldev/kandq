				...
				echo "<div class='row g-4'>";
					echo "<div class='col-lg-4'>";
						...
						echo "<div class='d-grid gap-2'>";
							echo "<a class='btn btn-success rounded-pill' href='" . $baseUrl . "assets/includes/customer/cart.inc.php?addToCart&id=" . $row["id"] . "'>Add to Cart</a>";
						echo "</div>";
						...
						while ($row2 = mysqli_fetch_assoc($result2)) {
							...
							echo "<div class='card'>";
								echo "<div class='card-body d-flex'>";
									echo "<img class='rounded me-4' width='20%' src='" . $baseUrl . "assets/uploads/profiles/" . $row2["profile"] . "'>";

									echo "<div class='d-flex flex-column'>";
										echo "<a class='mb-2' href='./seller?id=" . $row2["id"] . "'>" . $row2["firstname"] . " " . $row2["lastname"] . "</a>";

										echo "<a class='btn btn-primary btn-sm' href='../chat?id=" . $row2["id"] . "'>
